...
class AdminOrganization extends \PTAdmin\Foundation\Database\Models\AbstractModel
{
    protected $table = 'admin_organizations';
    ...
    {
        return $this->hasMany(AdminDepartment::class, 'organization_id');
    }
}
