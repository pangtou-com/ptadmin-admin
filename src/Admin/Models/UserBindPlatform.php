 ...
 * 用户账户绑定多平台.
 *
 * @property string $source   平台类型
 * @property string $open_id  平台ID
 * @property string $nickname 昵称
 * @property string $avatar   头像
 * @property string $union_id 微信多平台共同ID
 * @property int    $user_id  用户ID
 */
class UserBindPlatform extends \PTAdmin\Foundation\Database\Models\AbstractModel
{
