...
class Link extends AbstractModel
{
    ...
    protected $fillable = [
        'type', 'category', 'url', 'title', 'email', 'intro', 'weight', 'status',
    ];
    ...
    {
        return TypeEnum::getDescription($this->attributes['type'] ?? 0);
    }
    ...
    public function getStatusTextAttribute(): string
    {
        ...
        return StatusEnum::getDescription($val);
    }
}
