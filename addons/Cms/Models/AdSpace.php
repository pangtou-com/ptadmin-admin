 ...
 * @property int    $status
 */
class AdSpace extends AbstractModel
{
    use ModelCache;
    use SoftDeletes;
    protected $table = 'cms_ad_spaces';

    protected $fillable = [
        'title', 'space_type', 'width', 'height', 'code', 'status', 'description', 'carousel_interval',
        'max_ads', 'default_content', 'template',
    ];
}
