...
@section("script")
    <script>
        layui.use(['dropdown', 'layer', 'common', 'form', 'laytpl', 'laypage', 'PTCloud'], function () {
            const {dropdown, layer, common, form, laytpl, laypage, PTCloud} = layui;
