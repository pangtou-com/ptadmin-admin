...
UE.I18N['en'] = {
    ...
    'loadconfigError': 'Get server config fail.',
    'loadconfigFormatError': 'Server config format fail.',
    'loadconfigHttpError': 'Get server config http fail.',
    'snapScreen_plugin':{
        'browserMsg':"Only IE supported!",
        'callBackErrorMsg':"The callback data is wrong,please check the config!",
        'uploadErrorMsg':"Upload fail,please check your server environment! "
    },
    'insertcode':{
        'as3':'ActionScript 3',
        'bash':'Bash/Shell',
    ...
    'insertvideo':{
        ...
        'fileTypeError':'File type fail！',
        'unknownError':'Unknown fail！',
        'fileUploading':'Uploading,please wait...',
        'cancelUpload':'Cancel upload',
        'netError':'Network fail',
        'failUpload':'Upload failed',
        'serverIOError':'Server IO fail！',
    ...
    wordimage:{
        ...
        netError:"Network fail! Please try again!",
