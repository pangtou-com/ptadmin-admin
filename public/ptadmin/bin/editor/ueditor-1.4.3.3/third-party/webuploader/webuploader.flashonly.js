...
(function( root, factory ) {
    ...
    define('widgets/image',[
        ...
        return Uploader.register({
             ...
             *     var $li = ...;
             *
             *     uploader.makeThumb( file, function( fail, ret ) {
             *         if ( fail ) {
             *             $li.text('预览错误');
             *         } else {
    ...
    define('widgets/queue',[
        ...
        return Uploader.register({
             ...
             * console.log( uploader.getFiles('fail') )    // => all fail files.
             */
            getFiles: function() {
    ...
    define('widgets/validator',[
         ...
         * @description 当validate不通过时，会以派送错误事件的形式通知调用者。通过`upload.on('fail', handler)`可以捕获到此类错误，目前有以下错误会在特定的情况下派送错来。
         *
