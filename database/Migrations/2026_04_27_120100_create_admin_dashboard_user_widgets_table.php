...
return new class extends Migration
{
    ...
    {
        Schema::create('admin_dashboard_user_widgets', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unique(['tenant_id', 'user_id', 'widget_code'], 'uniq_admin_dashboard_user_widgets');
            $table->index('user_id', 'idx_admin_dashboard_user_widgets_user_id');
